<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="dictName" :label="String($t('config.dictName'))" show-overflow-tooltip />
      <el-table-column prop="dictKey" :label="String($t('config.dictKey'))" show-overflow-tooltip />
